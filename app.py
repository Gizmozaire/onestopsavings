...
def send_email(subject, html_content, recipient, sender='drplantme@gmail.com', admin_copy=False):
    ...
    with smtplib.SMTP_SSL('smtp.gmail.com', 465) as server:
        server.login(sender, 'znuj dcxb kexm fjyl')  # Use App Password from Google
